            ...
            <div class="container-fluid">
                <form method="GET" action="">
                    <div class="row mb-3">
                        ...
                        <!-- Tombol tambah untuk data siswa -->
                        <div class="d-flex justify-content-end">
    <a href="register.php" class="btn btn-primary"><i class="fa fa-user"></i>Tambah Siswa</a>
</div>
                ...
                <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            $count_query = "SELECT COUNT(*) as total FROM users WHERE username LIKE '%$search%'";
                            if ($year) {
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <img src="../foto/<?php echo $data['foto']; ?>" class="img-fluid" style="max-width: 75px;">
                                </td>
                                <td class="text-center">
                                    <a href="edit.php?id=<?php echo $data['id']; ?>" class="btn btn-success"><i class="fa fa-edit"></i>Edit</a>
                                    <a href="hapus.php?id=<?php echo $data['id']; ?>" class="btn btn-warning"><i class="fa fa-trash"></i>Hapus</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
